...
sections:
  - type: GenericSection
    ...
    text: |+
      ...
      <address><p><a href="https://maps.google.com/?q=21+rue+du+Soleil+67300+Schiltigheim" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:6px;color:#11295c;text-decoration:none;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 120" width="20" height="24"><defs><linearGradient id="g" x1="10%" y1="5%" x2="90%" y2="95%"><stop offset="0%" stop-color="#EA4335"/><stop offset="15%" stop-color="#E53935"/><stop offset="28%" stop-color="#FB8C00"/><stop offset="42%" stop-color="#FDD835"/><stop offset="57%" stop-color="#43A047"/><stop offset="72%" stop-color="#00ACC1"/><stop offset="88%" stop-color="#1E88E5"/><stop offset="100%" stop-color="#3949AB"/></linearGradient></defs><path fill-rule="evenodd" d="M50 5C25 5,5 25,5 50C5 65,12 78,25 88L50 115L75 88C88 78,95 65,95 50C95 25,75 5,50 5ZM50 27C38.95 27,30 35.95,30 47C30 58.05,38.95 67,50 67C61.05 67,70 58.05,70 47C70 35.95,61.05 27,50 27Z" fill="url(#g)"/></svg> 21 rue du Soleil 67300 Schiltigheim</a></p></address>
