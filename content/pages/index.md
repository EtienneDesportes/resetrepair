  ...
  - type: GenericSection
    ...
    text: |+
      ...
      <div style="margin:1em 0 0 0;">
        ...
        <a href="https://wa.me/33678235040" target="_blank" rel="noopener" style="display:block !important;max-width:260px;padding:10px 18px;border-radius:50px;color:#fff;font-weight:600;font-size:0.85rem;background:#25D366;box-shadow:0 2px 10px rgba(37,211,102,0.5);text-decoration:none;">
          <span style="display:inline-flex;align-items:center;gap:8px;">
