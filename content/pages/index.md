...
sections:
  - type: GenericSection
    ...
    text: |+
      ...
      <address><p><a href="https://maps.google.com/?q=21+rue+du+Soleil+67300+Schiltigheim" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:6px;color:#11295c;text-decoration:none;"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="#4285F4" d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg> 21 rue du Soleil 67300 Schiltigheim</a></p></address>
